...
inline void MICHELLE_ADAMS::announce_start() {
	std::string a;
	switch(random(0, 4)) {
		case 0: a = "It's that time of the week again where you will be hearing the greatest and freshest hits of your most famous artificial musicians, and I'm so proud to personally bring them to you. I'm your host Michelle Adams. I wish you a great listening experience!"; break;
		...
		case 4: a = "Welcome to the radio that brings you the latest Artificial Intelligence hits wherever you are in the world. We are starting of with a great song, performed by a band with cuttinf edge technology and precicion. They really know how to surprise you in many ways. I'm your favorite host Michelle Adams. And here is that tune!"; break;
	}
	say(a);
}
